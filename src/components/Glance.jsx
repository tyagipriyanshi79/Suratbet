                ...
                <div className='flex flex-col w-full gap-10 items-end mt-28'>
                    ...
                    >
                        <div className='p-5'>
                            ...
                            <h3 className='plain-heading special-font text-2xl md:text-xl'>
                        ...
                        <div className="overflow-hidden rounded-md">
                            {videoError ? (
                                <div className="bg-gray-500 flex items-center justify-center text-white h-full w-full">
                ...
                <div className='flex flex-col w-full gap-10 items-start'>
                    ...
                    >
                        <div className='p-2'>
                            ...
                            <h1 className='plain-heading special-font text-black text-[1rem] px-4 md:text-[1rem] leading-none md:leading-[6rem] text-start'>
