...
const Hero = () => {
  ...
  return (
    <div id="hero" className="relative h-dvh w-screen overflow-x-hidden">
      ...
      {/* Overlay container for heading, button, and video preview */}
      <div className="absolute left-0 top-0 z-40 size-full flex flex-col">
        <div className="mt-24 px-5 sm:px-10">
          ...
          {/* Container for button and video preview */}
          <div className="relative flex flex-col items-center mt-4 sm:flex-row sm:items-start sm:mt-4">
            {/* Button */}
            ...
            <div className="order-2 sm:order-none sm:absolute sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 mask-clip-path z-50 size-32 cursor-pointer overflow-hidden rounded-lg will-change-transform">
              <VideoPreview>
                <div
