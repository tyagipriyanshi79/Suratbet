        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-white-50">
              ...
              %50’si kadar ekstra bonus kazanma şansın var. Sürat Prime
              ayrıcalıkları, doğum günü sürprizleri, çevrimsiz spor bonusları ve
              anlık kazanç destekleriyle her anın dolu dolu geçecek. Süratbet’te
              kazandıran sistem hep yanında!
            </p>
            <Button
              id="watch-trailer"
              title="Hemen Oyna"
